...
public class KawasakiDiffusion : MonoBehaviour
{
		...
		public float ComputeEnergyChange(GameObject cell, GameObject neighbourCell){
			...
			GameObject tempCell = cell;
			cells[(int)cell_pos.x, (int)cell_pos.y] = neighbourCell;
			cells[(int)neighbour_pos.x, (int)neighbour_pos.y] = tempCell;
			...
			cells[(int)neighbour_pos.x, (int)neighbour_pos.y] = cells[(int)cell_pos.x, (int)cell_pos.y];
			cells[(int)cell_pos.x, (int)cell_pos.y] = tempCell;
